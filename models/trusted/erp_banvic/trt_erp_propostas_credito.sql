with
    ...
    , renomeado as (
        select
            ...
            , cast(taxa_juros_mensal as numeric(10,4)) as taxa_juros_mensal
            , cast(valor_proposta as numeric(32, 2)) as valor_proposta
            , cast(valor_financiamento as numeric(32, 2)) as valor_financiamento
            , cast(valor_entrada as numeric(32, 2)) as valor_entrada
            , cast(valor_prestacao as numeric(32, 2)) as valor_prestacao
